...
let
  ...
  traefikChartVersion = "9.14.2"; # taken from ./scripts/download at the above k3s tag
  ...
  traefikChart = fetchurl {
    ...
    sha256 = "VTkJmnAQJ7ZMowsVTIPhQOPHBqvoIM5WgxBwbIFxil4=";
  };
  ...
  k3sPlugins = buildGoPackage rec {
    ...
    src = fetchFromGitHub {
      ...
      repo = "plugins";
      rev = "v${version}";
      sha256 = "uAy17eRRAXPCcnh481KxFMvFQecnnBs24jn5YnVNfY4=";
    };
  ...
  k3sRepo = fetchgit {
    ...
    sha256 = "JgC8nTB8f0WOZnslI7dlGuD7hrWyi0XN7ookhaAdtmY=";
  };
